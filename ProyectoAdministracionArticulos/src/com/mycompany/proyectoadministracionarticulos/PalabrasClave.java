...
public class PalabrasClave implements Comparable<PalabrasClave> {
    ...
    public boolean equals(Object x) {
        ...
        PalabrasClave that = (PalabrasClave) x;
    ...
    public String toString() {
        ...
        StringF.append("Palabra Clave: '").append(palabra).append("'");
        StringF.append(" (Frecuencia: ").append(frecuencia).append(")");
        ...
        if (titulosArticulos != null && !titulosArticulos.esVacio()) {
            for (int i = 0; i < titulosArticulos.Tamaño(); i++) {
                StringF.append("'").append(titulosArticulos.ObtenerPorIndice(i)).append("'");
